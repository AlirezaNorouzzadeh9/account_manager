 ...
 *
 * DNS-backed WireGuard profile failover is a SEPARATE, domain-centric check
 * (see the wireguard:check-profiles command / CheckWireguardProfileJob) —
 * it tests each profile's own domain, independent of whether any server in
 * this bot is tracking that IP at all.
 */
